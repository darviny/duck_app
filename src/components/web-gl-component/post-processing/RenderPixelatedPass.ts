...
export default class RenderPixelatedPass extends Pass {
    ...
    render(
        ...
        // @ts-expect-error: fsQuad.material may not have 'uniforms' property in type definition
        ...
        return new THREE.ShaderMaterial( {
            ...
            fragmentShader:
                ...
                void main() {
                    ...
                    float coefficient = dei > 0.0 ? (1.0 - depthEdgeCoefficient * dei * 0.6) : (1.0 + normalEdgeCoefficient * nei * 0.6);
